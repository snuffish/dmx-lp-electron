...
import SecureElectronLicenseKeys from 'secure-electron-license-keys'
import Protocol from './protocol'
import MenuBuilder from './menu'
import i18nextBackend from 'i18next-electron-fs-backend'
import i18nextMainBackend from '../localization/i18n.mainconfig'
...
export default class Main {
  ...
  private static onWebContentsCreated(event: Event, contents: WebContents) {
  ...
  static onWillAttachWebView(contentsEvent, webPreferences, params) {
  ...
  private static onWillNavigate(contentsEvent: Event, navigationUrl) {
  ...
  private static onWillRedirect(contentsEvent: Event, navigationUrl: string) {
  ...
  private static createWindow() {
    ...
    ContextMenu.mainBindings(ipcMain, Main.mainWindow, Menu, isDev, {
      loudAlertTemplate: [
        {
          id: 'loudAlert',
          label: 'AN ALERT!',

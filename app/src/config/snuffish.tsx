  ...
  scenes: {
    ledbar: {
      components: [
        ...
        <SliderComponent key='slider5' orientation='horizontal' row={5} sector={5} color={COLORS.GREEN} />,
        <SliderComponent key='slider6' row={6} sector={6} color={COLORS.BLUE} />,
        <SliderComponent key='slider7' row={7} sector={7} color={COLORS.RED} />,
        <SliderComponent key='slider8' orientation='vertical' row={8} sector={8} color={COLORS.GREEN} />,
      ]
    },
    // laser: {
    //   components: [
